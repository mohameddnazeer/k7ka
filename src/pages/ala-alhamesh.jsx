...
export default function AlaAlhameshPage() {
    ...
    const reportsData = {
        ...
        3: {
            title: "أم بطل من ذوي الاعاقة: المعركة اليومية في مواجهة مجتمع غير مهيأ",
            tag: "صمود وتحدي",
            icon: "",
            ...
            conclusion: "أم بطل من ذوي الاعاقة ليست بطلة خارقة بالضرورة؛ هي إنسانة تتحمل فوق طاقتها، ودعمها ليس منة من أحد، بل هو واجب تشريعي وإنساني متكامل.",
